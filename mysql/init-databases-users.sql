...
CREATEDB[SC]="CREATE DATABASE IF NOT EXISTS $SC_DB_NAME;"
...
CREATEDB[TRICKSERVICE]="CREATE DATABASE IF NOT EXISTS $TRICKSERVICE_DB_NAME;"

declare -A CREATEUSER
CREATEUSER[FE]="CREATE USER '$FE_DB_USER'@'172.17.0.%' IDENTIFIED BY '$FE_DB_PASS';"
CREATEUSER[SC]="CREATE USER '$SC_DB_USER'@'172.17.0.%' IDENTIFIED BY '$SC_DB_PASS';"
...
CREATEUSER[TRICKSERVICE]="CREATE USER '$TRICKSERVICE_DB_USER'@'172.17.0.%' IDENTIFIED BY '$TRICKSERVICE_DB_PASS';"

declare -A GRANTPRIV
GRANTPRIV[FE]="GRANT ALL PRIVILEGES ON $FE_DB_NAME.* TO '$FE_DB_USER'@'172.17.0.%';"
GRANTPRIV[SC]="GRANT ALL PRIVILEGES ON $SC_DB_NAME.* TO '$SC_DB_USER'@'172.17.0.%';"
...
GRANTPRIV[TRICKSERVICE]="GRANT ALL PRIVILEGES ON $TRICKSERVICE_DB_NAME.* TO '$TRICKSERVICE_DB_USER'@'172.17.0.%';"
